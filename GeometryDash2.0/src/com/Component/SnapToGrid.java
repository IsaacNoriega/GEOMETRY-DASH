...
public class SnapToGrid extends Component {
    private float debounceTime=100f;
    ...
    public void update(double dt){
        ...
        if (this.gameObject.getComponent(Sprite.class) != null){
            float x= (float) Math.floor((Window.getWindow().mouseListener.x + Window.getWindow().getCurrentScene().camera.position.x
                    + Window.getWindow().mouseListener.dx)/gridWidth);
            float y= (float) Math.floor((Window.getWindow().mouseListener.y + Window.getWindow().getCurrentScene().camera.position.y
                    + Window.getWindow().mouseListener.dy)/gridWidth);
            ...
            if (Window.getWindow().mouseListener.mousePressed &&
               ...
               // object.removeComponent(SnapToGrid.class);
    ...
    public void draw(Graphics2D g2){
        ...
        if(sprite != null){
            ...
            g2.setComposite(ac);g2.drawImage(sprite.image,(int)gameObject.transform.position.x,(int)gameObject.transform.position.y,
